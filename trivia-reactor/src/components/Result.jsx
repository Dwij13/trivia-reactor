      ...
      <div className='body-div'>
        <div className='body-box'>
            <div className='result-div'>
                <div className='result'><u>Result</u></div>
                <div className='correct-ques' >{score} /75</div>
                <div className='percentage' > {Math.floor(score/75*100)}% </div>
            </div>
            <div className='restart-div'>
            <div className='restart-box' onClick={()=>{
                setClick("quizz")
                setScore(0)
            }}>
                Reset
